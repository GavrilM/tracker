...
import { CELL_SIZE, CellCategories, getCategoryColor } from "@my/ui";
...
export function EditCell({ name, category, onEdit, onColor, onPressIn, onPressOut }: EditCellProps) {
  ...
  return (
    ...
    <ColorSheet isOpen={showSheet} selectedColor={category} 
      onSelect={onColor} onClose={() => setShowSheet(false)}/>
    </>
  )
}
